...
def Construction():
    ...
    RC_PAYLOAD = "windows/x64/meterpreter_reverse_http"

    print(core.amcolors.PURPLE + core.amcolors.PURPLE + "[STAGELESS] Payload x64 Meterpreter Reverse HTTP" + core.amcolors.ENDC)
