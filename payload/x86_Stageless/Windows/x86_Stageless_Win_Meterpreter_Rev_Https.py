...
def Construction():
    ...
    RC_PAYLOAD = "windows/meterpreter_reverse_https"

    print(core.amcolors.PURPLE + core.amcolors.BOLD + "[STAGELESS] Payload x86 Meterpreter Reverse HTTPS" + core.amcolors.ENDC)
